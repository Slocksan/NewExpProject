...
namespace NewExpProject.Data
{
    public class AppDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            var connString = "dbname=d5pb39t2qg3oa7 host=ec2-52-86-115-245.compute-1.amazonaws.com port=5432 user=jippsvmugllwte password=b0a462b403a9139b9cebdfaade5d0882ca946aa53a35659be5243120dc883f89 sslmode=require";
